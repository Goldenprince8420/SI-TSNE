...
annoy_path = "tsne_model/dependencies/annoy/"
annoy = Extension(
    "tsne_model.dependencies.annoy.annoylib",
...
# Other extensions
extensions = [
    Extension("tsne_model.quad_tree", ["tsne_model/quad_tree.pyx"], language="c++"),
    Extension("tsne_model._tsne", ["tsne_model/_tsne.pyx"], language="c++"),
    Extension("tsne_model.kl_divergence", ["tsne_model/kl_divergence.pyx"], language="c++"),
    annoy,
]
...
if has_c_library("fftw3"):
    ...
    extension_ = Extension(
        "tsne_model._matrix_mul.matrix_mul",
        ["tsne_model/_matrix_mul/matrix_mul_fftw3.pyx"],
        libraries=["fftw3"],
        language="c++",
    )
    ...
    extension_ = Extension(
        "tsne_model._matrix_mul.matrix_mul",
        ["tsne_model/_matrix_mul/matrix_mul_numpy.pyx"],
        language="c++",
    )
    extensions.append(extension_)
...
exec(open(os.path.join("tsne_model", "version.py")).read())
...
setup(
    ...
    packages=setuptools.find_packages(include=["tsne_model", "tsne_model.*"]),
    python_requires=">=3.6",
    install_requires=[
        "numpy>=1.16.6",
        "scikit-learn>=0.20",
