...
from openTSNE_custom import utils
...
class Annoy(KNNIndex):
    ...
    def build(self):
        ...
        from openTSNE_custom.dependencies.annoy import AnnoyIndex
    ...
    def check_metric(self, metric):
        ...
        if not np.array_equal(
            ...
            warnings.warn(
                ...
                "and `tsne_model.nearest_neighbors` has not been updated. Please notify the "
        ...
        if callable(metric):
            ...
            if not isinstance(metric, CPUDispatcher):
                warnings.warn(
                    ...
                    f"`tsne_model.nearest_neighbors.NNDescent` "
        ...
        if np.sum(mask) > 0:
            if self.verbose:
                ...
                warnings.warn(
                    ...
                    f"As a workaround, tsne_model considers all such points similar to "
