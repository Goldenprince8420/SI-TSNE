...
from openTSNE_custom import affinity, initialization, nearest_neighbors
...
TSNE = partial(openTSNE_custom.TSNE, **tsne_params)
...
class TestUsageLowestLevel(TestUsage):
    def test_1(self):
        ...
        embedding = openTSNE_custom.TSNEEmbedding(init, aff)
