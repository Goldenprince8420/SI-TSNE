...
from manifold_learning.src.python.manifold_learning.se import sim_potential
from manifold_learning.src.python.utils.graph import create_feature_mat, compute_adjacency, \
                               create_laplacian
